...
* Couchbase Server 6.0 or later with the travel-sample bucket setup
* Couchbase C Library -
...
```
Commandline arguments can also be passed in through the terminal:
```
$ python travel.py --user Administrator --password Password --cluster localhost
```
